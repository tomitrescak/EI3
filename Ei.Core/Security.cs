...
namespace Ei
{
    ...
    public struct AuthorisationInfo
    {
        ...
        public AuthorisationInfo(string user, string password, string organisation, params Group[] groups) {
            User = user;
            Password = password;
    ...
    public class Security
    {
        ...
        public Security(Institution ei) {
            this.ei = ei;
            this.authorisations = new List<AuthorisationInfo>();
        }

        public void Add(params AuthorisationInfo[] auth) {
            if (auth != null) {
