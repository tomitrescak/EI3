...
namespace Ei.Runtime
{
    ...
    public class Governor : IGovernor, IStateProvider
    {
        ...
        public struct Context
        {
            ...
            public Context(Connection connection, Workflow wf)
            {
        ...
        public class GovernorVariableState : VariableState
        {
            public int CreatedInstanceId;
            public string Name;
            public Governor Governor;

            public Workflow.WorkflowVariableState WorkflowVariableState { get; internal set; }
            ...
            public override VariableState Clone(VariableState state) {
        ...
        public Workflow Workflow { get { return this.currentContext.Workflow; } }
...
//        }
        ...
        internal void EnterWorkflow(Connection connection, Workflow workflow)
        {
            // change context
...
//                }
        ...
        internal void NotifyEnteredWorkflow(Workflow workflow)
        {
            this.LogAction(
        ...
        internal void NotifyActivity(Workflow workflow, string agentName, string activityId, VariableState parameters)
        {
        ...
        internal void NotifyActivityFailed(Workflow workflow, string agentName, string activityId, VariableState parameters)
        {
       ...
       public  struct GoalDescription
        ...
        public static List<GoalDescription> FindGoals(Workflow workflow, VariableState agentState, Group[] groups, GoalState[] goalState, int maxGoals = int.MaxValue)
        {
...
//                        }
        ...
        private static float CalculateRatio(GoalState[] goals, VariableState startState, VariableState changedState)
        {
            var maxRatio = 0f;
        ...
        public List<AStarNode> PlanGoalState(GoalState[] goals, PlanStrategy strategy, ICostManager costManager = null)
        {
            ...
            switch (strategy)
            {
                ...
                case PlanStrategy.BackwardSearch:
                    var goal = Governor.FindGoals(this.Workflow, state, Groups, goals, 1);
