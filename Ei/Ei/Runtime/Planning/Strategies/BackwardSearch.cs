...
namespace Ei.Runtime.Planning.Strategies
{
    internal class BackwardSearch : IStrategy
    {
        ...
        private BackwardSearch(Workflow.Instance workflow, VariableState agentState, Group[] agentGroups, WorkflowPosition position)
        {
...
//        }
        ...
        /// </summary>
        public BackwardSearch(Workflow.Instance workflow, VariableState agentState, Group[] agentGroups, WorkflowPosition position, Connection startConnection, GoalState[] startState) :
            this(workflow, agentState, agentGroups, position)
        {
            this.startState = startState;
