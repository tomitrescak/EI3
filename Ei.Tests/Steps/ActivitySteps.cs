...
namespace Ei.Tests.Steps
{
    ...
    public class ActivitySteps
    {
        ...
        public void ThenAgentWaitMoveToPortInWorkflow(string agentName, string positionId, string workflowId)
        {
            ...
            {
                Log.Debug("[AGENT ARRIVED] " + agent.Object.Name + " - " + agent.Object.Workflow.Id + "." + agent.Object.Position.Id);
                waiter.Set();
            }); 
            ...
            try
            {
                ...
                Log.Debug("[AGENT ALREADY THERE] " + agent.Object.Name + " - " + agent.Object.Workflow.Id + "." + agent.Object.Position.Id);
                waiter.Set();
            }
            catch 
            {
