  ...
  render() {
    ...
    return (
      <Form>
        ...
        <AccessEditor ei={ei} access={state.EntryRules} name={'state_entry_' + state.Id} workflow={workflow} />

        <Header as="h4" icon="legal" content="Exit Rules" />
        <AccessEditor ei={ei} access={state.ExitRules} name={'state_exit_' + state.Id} workflow={workflow} />
