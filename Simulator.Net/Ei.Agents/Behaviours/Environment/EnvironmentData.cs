...
//        public string Id;
//        public EnvironmentDataAction[] Actions;
//        public int X;
//        public int Y;
...
//        public EnvironmentData(string id, EnvironmentDataAction[] actions, int x, int y, Dictionary<string, VariableInstance[]> parameters = null, Governor owner = null)
//        {
...
//            this.uses = new Dictionary<string, int>();
//            this.Id = id;
//            this.Actions = new[] { new EnvironmentDataAction { Id = actionName, DestroyAfter = destroyAfter } };
//            this.X = x;
//            this.Y = y;
//            this.Owner = owner;
//            this.Parameters = parameters;
