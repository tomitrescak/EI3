...
namespace Ei.Simulation.Sims.Behaviours
{
    public class Spawn : EiBehaviour, IUpdates
    {
        ...
        public void Start() {
            this.minX = 0;
            this.maxX = (float)this.Width - 50;
            this.minY = 0;
            this.maxY = (float)this.Height - 50;
        ...
        void SpawnAgents() {
            ...
            if (this.Type == AgentType.Sim) {
                this.simulation.ProcessStatistics(new SimsStatistics());
                //this.simulation.Statistics.ProcessStatistics(new FpsStatistics());
            } else {
                this.simulation.ProcessStatistics(new FpsStatistics());
            }
...
//            }
        ...
        void SpawnRandomWalker(GameObject agent) {
            ...
            rnav.Width = (float) this.Width;
            rnav.Height = (float) this.Height;
        }
