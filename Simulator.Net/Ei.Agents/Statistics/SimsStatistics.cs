...
namespace Ei.Simulation.Statistics
{
    ...
    public class SimsStatistics : IStatistic
    {
        ...
        public int ProcessTimeInMilliseconds => 2000;
        ...
        public SimsStatistics() {
            ...
            this.Traits.Add(
                this.CreateTrait("Average Happiness", data => data.happiness / 100, 6,
                    StatisticRelaxationStrategy.Average, 2, LineStyle.Dot));
            this.Traits.Add(
                this.CreateTrait("Dead", data => data.dead, 6, StatisticRelaxationStrategy.Average, 4,
                    LineStyle.LongDash));

            this.Traits.Add(this.CreateTrait("Hunger", data => data.hunger, 6, StatisticRelaxationStrategy.Average, 2));
            this.Traits.Add(this.CreateTrait("Thirst", data => data.thirst, 6, StatisticRelaxationStrategy.Average, 2));
            this.Traits.Add(this.CreateTrait("Energy", data => data.energy, 6, StatisticRelaxationStrategy.Average, 2));
            this.Traits.Add(this.CreateTrait("Comfort", data => data.comfort, 6, StatisticRelaxationStrategy.Average, 2));
            this.Traits.Add(this.CreateTrait("Fun", data => data.fun, 6, StatisticRelaxationStrategy.Average, 2));
            this.Traits.Add(this.CreateTrait("Social", data => data.social, 6, StatisticRelaxationStrategy.Average, 2));
            this.Traits.Add(this.CreateTrait("Hygiene", data => data.hygiene, 6, StatisticRelaxationStrategy.Average, 2));
            this.Traits.Add(this.CreateTrait("Room", data => data.room, 6, StatisticRelaxationStrategy.Average, 2));
        }
        ...
        public void ProcessSamples() {
            ...
            foreach (var trait in this.Traits) {
                ((StatisticTrait<SimsStatistic>) trait).Process(
                    Time.time * 60 * BehaviourConfiguration.SimulatedMinutesToReal, statistic);
            }
        }
        ...
        private StatisticTrait<SimsStatistic> CreateTrait(string name,
            ...
            return new StatisticTrait<SimsStatistic>(name, func, relaxationPeriod, relaxationStreategy, thickness,
                lineStyle);
        }
    }
}